      ...
      <div className="container-narrow">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {tools.map((tool, idx) => (
            ...
            >
              <Card
                className="p-4 flex-1 bg-white border-[#E2E5EA] hover-elevate cursor-pointer transition-all duration-300 group flex flex-row items-start gap-4"
              ...
              >
                ...
                <div className="flex flex-col flex-1 min-w-0">
                  <h3 className="text-[14px] font-bold text-[#0A2E76] font-heading mb-1 leading-snug">
                    {tool.title}
                  </h3>
                  <p className="text-[13px] text-[hsl(215,15%,45%)] leading-relaxed">
                    {tool.description}
                  </p>
                </div>
              </Card>
