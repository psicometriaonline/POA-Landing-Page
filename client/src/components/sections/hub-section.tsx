    ...
    >
      <div className="container-narrow">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-white font-semibold leading-relaxed max-w-3xl mx-auto mb-8">
          ...
          <p className="text-body-lg md:text-xl text-white/85 leading-relaxed max-w-3xl mx-auto mb-8">
            Iremos desenvolver em você as três principais competências acadêmicas.
            <br />
            Nossos cursos irão te levar do zero até o avançado em método e pesquisa quantitativa.
            <br />
            Você irá se transformar em um(a) pesquisadora de ponta.
          </p>
